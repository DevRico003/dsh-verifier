...
export function criteriaFor(name, toolCalls) {
...
export function callLogger(log, prefix) {
...
export function baseVerifierOptions(config, backend, set, evaluations, signal, log, prefix) {
    return {
        backend,
