...
function baseOptions(deps, criteriaName, evaluations, signal) {
...
export function installTools(ctx, deps) {
    ctx.tools.register(defineTool({
        ...
        description: 'Best-of-N selection: given the task and several candidate outputs (answers, patches, plans, drafts), an independent '
    ...
    ctx.tools.register(defineTool({
        ...
        description: 'Directed pairwise verification of two candidate outputs for a task. Returns rewards in [0,1] for A and B '
    ...
    ctx.tools.register(defineTool({
        ...
        description: 'Strict independent assessment of ONE draft answer / result against the task: returns a reward in [0,1] per criterion '
