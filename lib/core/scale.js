...
export function pairwiseValue(letter) {
...
export function progressValue(letter) {
    const index = LETTERS.indexOf(letter.toUpperCase());
...
export const PAIRWISE_SCALE_DESCRIPTION = 'Rate how likely the agent correctly solved the task on a '
...
export const PROGRESS_SCALE_DESCRIPTION = 'Use the 20-letter A..T scale:\n'
