...
export class OpenAICompatibleBackend {
    ...
    async complete(request) {
        ...
        if (text.trim() === '') {
            ...
            throw new Error(`dsh-verifier: backend ${this.label} returned no answer text (finish_reason=${choice.finish_reason ?? 'unknown'}, reasoning chars=${reasoned}); raise backend.maxTokens or lower backend.reasoningEffort`);
        }
